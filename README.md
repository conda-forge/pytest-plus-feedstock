...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-plus-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11667&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-plus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-plus` can be installed with:

```
conda install pytest-plus
```

It is possible to list all of the versions of `pytest-plus` available on your platform with:
